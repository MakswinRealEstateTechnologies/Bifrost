...
public extension Bifrost.DisposableHandle {
  /**
...
public extension UIKit.UILabel {
  ...
  public func bindText<T : NSString>(flow: CStateFlow<T>) -> DisposableHandle {
    return UILabelBindingsKt.bindText(self, flow: flow as! Bifrost.CStateFlow<Foundation.NSString>)
  }
}
...
public extension UIKit.UITextField {
  ...
  @discardableResult
  public func bindText<T : NSString>(flow: CStateFlow<T>) -> DisposableHandle {
    return UITextFieldBindingsKt.bindText(self, flow: flow as! Bifrost.CStateFlow<Foundation.NSString>)
  }
}
...
public extension UIKit.UITextView {
  ...
  @discardableResult
  public func bindText<T : NSString>(flow: CStateFlow<T>) -> DisposableHandle {
    return UITextViewBindingsKt.bindText(self, flow: flow as! Bifrost.CStateFlow<Foundation.NSString>)
  }
}
...
public extension UIKit.UIButton {
  ...
  public func bindTitle<T : NSString>(flow: CStateFlow<T>) -> DisposableHandle {
    return UIButtonBindingsKt.bindTitle(self, flow: flow as! Bifrost.CStateFlow<Foundation.NSString>)
  }
}
