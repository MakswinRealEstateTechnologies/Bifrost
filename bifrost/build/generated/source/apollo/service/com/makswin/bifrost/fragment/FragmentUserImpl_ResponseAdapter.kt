...
public object FragmentUserImpl_ResponseAdapter {
  public object FragmentUser : Adapter<com.makswin.bifrost.fragment.FragmentUser> {
    ...
    public override fun fromJson(reader: JsonReader, customScalarAdapters: CustomScalarAdapters):
        com.makswin.bifrost.fragment.FragmentUser {
      var id: String? = null
      ...
      return com.makswin.bifrost.fragment.FragmentUser(
        id = id!!,
        full_name = full_name,
    ...
    public override fun toJson(
      ...
      `value`: com.makswin.bifrost.fragment.FragmentUser,
    ): Unit {
      writer.name("id")
