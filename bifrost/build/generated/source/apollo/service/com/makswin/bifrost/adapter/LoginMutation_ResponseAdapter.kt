...
public object LoginMutation_ResponseAdapter {
  ...
  public object Login : Adapter<LoginMutation.Login> {
    ...
    public override fun fromJson(reader: JsonReader, customScalarAdapters: CustomScalarAdapters):
      ...
      reader.rewind()
      val fragmentAuth = com.makswin.bifrost.fragment.FragmentAuthImpl_ResponseAdapter.FragmentAuth.fromJson(reader,
    ...
    public override fun toJson(
      ...
      com.makswin.bifrost.fragment.FragmentAuthImpl_ResponseAdapter.FragmentAuth.toJson(writer,
