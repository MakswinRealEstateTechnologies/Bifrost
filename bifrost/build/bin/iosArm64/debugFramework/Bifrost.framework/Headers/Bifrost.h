...
- (void)test231231 __attribute__((swift_name("test231231()")));
@end;
...
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (NSString *)component3 __attribute__((swift_name("component3()")));
- (BifrostLanguage_ *)doCopyId:(int32_t)id key:(NSString *)key value:(NSString *)value __attribute__((swift_name("doCopy(id:key:value:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property int32_t id __attribute__((swift_name("id")));
...
- (instancetype)initWithLanguages:(NSArray<BifrostLanguage_ *> *)languages __attribute__((swift_name("init(languages:)"))) __attribute__((objc_designated_initializer));
...
@property NSArray<BifrostLanguage_ *> *languages __attribute__((swift_name("languages")));
@end;
